...
urlpatterns = [
    ...
    path('completed/<int:completed_id>/', views.completed_view, name="completed_view"),
    path('incomplete/<int:incomplete_id>/', views.incomplete_view, name="incomplete_view"),
    path('invalid/<int:invalid_id>/', views.invalid_view, name="invalid_view"),
